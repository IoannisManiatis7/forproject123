...
<main id="site-content" class="recipe-template" role="main">
    ...
    if ( have_posts() ) {
        while ( have_posts() ) {
            ...
            $tip = get_field('to_tipaki') ?? 'Δεν είναι διαθέσιμο';
            $source = get_field('recipe_source') ?? 'Δεν είναι διαθέσιμη';
...
<div class="recipe-grid">
    ...
    <div class="recipe-sidebar">
        <div class="recipe-info">
            ...
            <p class="info-text">Χρόνος Προετοιμασίας: <?php echo esc_html($prep_time); ?></p>
            <p class="info-text">Χρόνος Μαγειρέματος: <?php echo esc_html($cook_time); ?></p>
            <p class="info-text">Βαθμός Δυσκολίας:
                <?php 
    ...
    <div class="recipe-content">
        ...
        <div class="recipe-extra">
            <div class="tipaki-wrapper">
                <h2 class="tipaki-title"># το tipακι</h2>
                <?php if( !empty($tip) ): ?>
                    <div class="tipaki-list">
                        <?php echo wp_kses_post($tip); ?>
                    </div>
                <?php else : ?>
                    <p class="info-text">Δεν υπάρχει.</p>
                <?php endif; ?>
            </div>

            <div class="recipe-source">
                <p>Πηγή Συνταγής: <?php echo esc_html($source); ?></p>
            </div>
        </div>
    </div>
